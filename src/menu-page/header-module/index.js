...
export const createHeader = () => {
    ...
    const navItems = [
        ...
        {text: 'Menu', href: '../menu-page/template.html', className: 'nav-btn menu-btn current-btn'},
        {text: 'Contacts', href: '../contacts-page/template.html', className: 'nav-btn contacts-btn'},
    ];
